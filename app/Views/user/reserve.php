          ...
          <div id="input-area">
            <div id="range">
              ...
              <select name="range_id">
                ...
                <?php $oldRangeId = $session->flash('old.range_id') ?? $temporary['range_id'] ?? '';?>
            ...
            <div id="number">
              ...
              <select name="number">
                <option value="">選択してください</option>
                <?php $oldNumber = $session->flash('old.number') ?? $temporary['number'] ?? '';?>
            ...
            <div id="reserve-date">
              ...
              <select name="reserve_date">
                <option value="">選択してください</option>
                <?php $oldDate = $session->flash('old.reserve_date') ?? $temporary['reserve_date'] ?? '' ;?>
              ...
              <div id="time-flex">
                <div>
                  ...
                  <select name="start_time" id="start-time">
                    <option value="">選択してください</option>
                    <?php $oldStart = $session->flash('old.start_time') ?? $temporary['start_time']  ?? ''; ?>
                ...
                <div>
                  ...
                  <select name="end_time" id="end-time">
                    <option value="">選択してください</option>
                    <?php $oldEnd = $session->flash('old.end_time') ?? $temporary['end_time'] ?? '' ;?>
            ...
            <div id="option">
              ...
              <div>
                <?php $oldRental = $session->flash('old.rental') ?? $temporary['rental'] ?? '' ; ?>
              ...
              <ul>
                <li>
                  ...
                  <select id="club-select" name="rental_id">
                    <option value="">選択してください</option>
                      <?php $oldRentalId = $session->flash('old.rental_id') ?? $temporary['rental_id'] ?? '' ;?>
            ...
            <div id="shower-room">
              ...
              <div>
                <?php $oldShower = $session->flash('old.shower') ?? $temporary['shower'] ?? '' ; ?>
              ...
              <div>
                ...
                <select name="shower_time" id="shower-time">
                  <option value="">選択してください</option>
                  <?php $oldShowerTime = $session->flash('old.shower_time') ?? $temporary['shower_time'] ?? '' ;?>
                  <?php foreach($startTimes as $startTime):?>
